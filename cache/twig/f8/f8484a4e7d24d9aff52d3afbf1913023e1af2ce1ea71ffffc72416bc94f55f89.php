...
/* modular/one_third_left_two_thirds_right.html.twig */
class __TwigTemplate_ff0da48754578ab85fbbfc506d7c972fa0834ef95953f76506bfebfd6caca16f extends Twig_Template
{
...
<div class=\"grid pure-g-r\">
    ";
        ...
        ";
                ...
                // line 18
                echo "            <div  class=\"block size-2-3 pure-u-2-3\">
            ";
                // line 19
                if (($context["image"] ?? null)) {
                    // line 20
    ...
    {
        return "modular/one_third_left_two_thirds_right.html.twig";
    }
...
<div class=\"grid pure-g-r\">
    ...
    {% set image = p.media.images|first %}
        ...
        {% else %}
            <div  class=\"block size-2-3 pure-u-2-3\">
            {% if image %}
            <div class=\"cell-image\" style=\"background:url({{ image.url }}) no-repeat center center; height:220px; background-size:cover;\"></div> 
            {% endif %}
            <div>
...
</div>", "modular/one_third_left_two_thirds_right.html.twig", "C:\\MAMP\\htdocs\\parallel\\user\\themes\\parallel55\\templates\\modular\\one_third_left_two_thirds_right.html.twig");
    }
}
